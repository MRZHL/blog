# Generated by Django 2.1.7 on 2020-03-02 17:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('TestModel', '0002_auto_20200227_2244'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TestModel.Category', verbose_name='分类'),
        ),
        migrations.AlterField(
            model_name='post',
            name='create_time',
        ...
        migrations.AlterField(
            model_name='post',
            name='tag',
            field=models.ManyToManyField(blank=True, to='TestModel.Tag', verbose_name='标签'),
        ),
        migrations.AlterField(
            model_name='post',
            name='title',
